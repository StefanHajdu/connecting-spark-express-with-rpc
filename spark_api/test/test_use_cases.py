...
def test_06_unordered_summarize():
    ...
    assert df_session_2["num_rows"] > df_session_3["num_rows"]
...
def test_12_toggle():
    ...
    df_session_2 = u.summarize(session_id=session_0, node_id=node_2)
    assert df_session_2["num_rows"] == s.total_rows
    ...
    df_session_3 = u.summarize(session_id=session_0, node_id=node_2)
    assert df_session_3["num_rows"] > df_session_1["num_rows"]
    ...
    assert df_session_4["num_rows"] == df_session_1["num_rows"]
