...
curl -X POST http://localhost:4444/load -H 'Content-Type: application/json' -d '{"session_id": "0000", "df_path": "/home/stephenx/Documents/Datasets/domains_sub_test.csv", "df_type": "csv"}' -w '\nTotal: %{time_total}s\n'
